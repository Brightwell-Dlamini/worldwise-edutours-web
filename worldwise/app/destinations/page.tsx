...
import { GiAfricanTree, GiLion } from 'react-icons/gi';
...
const destinations = [
  {
    ...
    description: 'Immerse in authentic Swati culture, royal heritage, and breathtaking mountain landscapes.',
  ...
  },
  {
    ...
    description: 'Explore the capital city and "Valley of Heaven" with luxury resorts and craft markets.',
  ...
  },
  {
    ...
    description: 'Agricultural heartland with pineapple farms and authentic rural community experiences.',
    image: '/destinations/malkerns.jpg',
    programs: ['Agricultural Education', 'Community Service', 'Cultural Exchange'],
    duration: '4-6 days',
    season: 'Year-round',
    highlights: [
  ...
  },
  {
    ...
    description: 'Majestic wildlife sanctuary with lion, elephant, and rhino conservation programs.',
  ...
  },
  {
    ...
    region: 'Lubombo Region',
    description: 'Scenic mountain region with panoramic views and traditional healing heritage.',
  ...
  },
  {
    ...
    region: 'Hhohho Region',
    description: 'Visit Africa\'s oldest mine and watch artisans create beautiful recycled glass art.',
  ...
  },
  {
    ...
    region: 'Hhohho Region',
    description: 'Engineering marvel and nature reserve with waterfalls and indigenous forests.',
    image: '/destinations/maguga.jpg',
    programs: ['Engineering Tours', 'Environmental Studies', 'Adventure Education'],
    duration: '2-3 days',
    season: 'Mar-Nov',
    highlights: [
      'Maguga Dam Tour',
  ...
  },
  {
    ...
    region: 'Lubombo Region',
    description: 'Community-owned eco-tourism project with authentic Swati homestay experiences.',
...
export default function DestinationsPage() {
  ...
  const filteredDestinations = destinations.filter((destination) => {
    ...
    const matchesPrice = () => {
      ...
      if (selectedPrice === 'Under SZL 5,000') {
        const price = parseInt(destination.priceRange.split('-')[0].replace('SZL ', '').replace(',', ''));
        return price < 5000;
      }
      if (selectedPrice === 'SZL 5,000-10,000') {
        const min = parseInt(destination.priceRange.split('-')[0].replace('SZL ', '').replace(',', ''));
        const max = parseInt(destination.priceRange.split('-')[1]?.replace(',', '') || min.toString());
    ...
    return matchesSearch && matchesRegion && matchesProgram && matchesPrice() && matchesPremium;
  });
  ...
  const sortedDestinations = [...filteredDestinations].sort((a, b) => {
    ...
    if (sortBy === 'price') {
      const priceA = parseInt(a.priceRange.split('-')[0].replace('SZL ', '').replace(',', ''));
      const priceB = parseInt(b.priceRange.split('-')[0].replace('SZL ', '').replace(',', ''));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-amber-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-emerald-700 via-green-600 to-teal-600 py-24 md:py-32">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="max-w-3xl">
            ...
            <h1 className="font-serif font-bold text-5xl md:text-6xl lg:text-7xl text-white mb-6 leading-tight">
              Discover{' '}
              <span className="text-amber-300">Eswatini's</span>
              <br />
              Educational Treasures
            </h1>
            
            <p className="text-xl md:text-2xl text-white/90 mb-10 font-light max-w-2xl">
              Immerse in authentic Swati culture, royal heritage, and transformative learning experiences across the Mountain Kingdom.
            </p>

            {/* Enhanced Search Bar */}
            <div className="relative max-w-2xl group">
              <div className="absolute -inset-1 bg-gradient-to-r from-amber-400 to-emerald-400 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 w-full lg:w-auto">
              <div className="flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-gray-700 dark:to-gray-800 rounded-xl">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <div className="relative">
                    <input
                      ...
                      className="sr-only"
                    />
                    <div className={`w-12 h-6 flex items-center rounded-full p-1 transition ${showPremiumOnly ? 'bg-gradient-to-r from-amber-500 to-orange-500' : 'bg-gray-300 dark:bg-gray-600'}`}>
                      <div className={`bg-white w-4 h-4 rounded-full shadow-md transform transition ${showPremiumOnly ? 'translate-x-6' : ''}`}></div>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12 text-center">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Curated <span className="text-emerald-600">Eswatini</span> Experiences
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Each destination is handpicked to offer authentic cultural immersion and educational excellence
            </p>
          ...
          {sortedDestinations.length === 0 ? (
            <div className="text-center py-24 bg-gradient-to-br from-white to-emerald-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl shadow-xl">
              <div className="max-w-md mx-auto">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-r from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30 rounded-full flex items-center justify-center">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-8">
                  Try adjusting your filters or explore all our Eswatini destinations
                </p>
                <button
                  onClick={resetFilters}
                  className="px-8 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-emerald-500/25 transition-all duration-300"
                >
                ...
                >
                  ...
                  {destination.premium && (
                    <div className="absolute top-4 right-4 z-20">
                      <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-4 py-2 rounded-full text-sm font-bold flex items-center gap-2 shadow-lg">
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {destination.programs.map((program, index) => (
                          <span
                            key={index}
                            className="px-3 py-1.5 bg-gradient-to-r from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30 text-emerald-700 dark:text-emerald-300 rounded-lg text-xs font-semibold border border-emerald-200 dark:border-emerald-800"
                          >
                            {program}
                          </span>
                        ))}
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-3">
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">{destination.duration}</p>
                      </div>
                      <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-3">
                        <div className="flex items-center gap-2 mb-1">
                          <GiAfricanTree className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
                          <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Best Season</span>
                        </div>
                        <p className="text-lg font-bold text-gray-900 dark:text-white">{destination.season}</p>
                      </div>
                    </div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {destination.highlights.slice(0, 3).map((highlight, index) => (
                          <span
                            key={index}
                            className="px-3 py-1.5 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium border border-gray-200 dark:border-gray-700"
                          >
                            {highlight}
                          </span>
                        ))}
                        {destination.highlights.length > 3 && (
                          <span className="px-3 py-1.5 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium border border-gray-200 dark:border-gray-700">
                    ...
                    >
                      <div className="relative overflow-hidden rounded-xl">
                        <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-teal-600 group-hover/btn:from-emerald-700 group-hover/btn:to-teal-700 transition-all duration-300"></div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative">
          ...
          <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
            Partner with Eswatini's premier educational tourism experts. 
            We create bespoke experiences that connect students with authentic 
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-amber-500 to-orange-500 group-hover:scale-105 transition-transform duration-300"></div>
          ...
          <div className="mt-12 pt-8 border-t border-white/20">
            <p className="text-white/80 text-sm">
              All prices in Emalangeni (SZL) • VAT included • Flexible payment options available
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-emerald-50 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Discover the unique advantages of educational tourism in Africa's last absolute monarchy
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-3xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
              <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-center">
                  Exclusive access to cultural sites and royal villages with official permission
                </p>
              </div>
            </div>
            
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-amber-500 to-orange-500 rounded-3xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
              <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl">
                <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 rounded-2xl flex items-center justify-center">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-center">
                  Community-owned projects that directly benefit local Swati communities
                </p>
              </div>
            </div>
            
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-green-500 to-emerald-500 rounded-3xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
              <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl">
